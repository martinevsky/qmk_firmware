...
// (C) https://www.reddit.com/r/MechanicalKeyboards/comments/1ec88th/comment/lfabt95/
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_91_ansi(
        ...
        _______,  KC_CAPS,  SOCD_A,   KC_S,     SOCD_D,   KC_F,     KC_G,      KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,              KC_ENT,             KC_HOME,
